...
| Release | Summary |
|---|---|
| [v0.7.1](./v0.7.1.md) | Sales Dashboard and operations release stabilization |
| [v0.7.0](./v0.7.0.md) | Consolidated Warehouse and Logistics operations workspace |
| [v0.6.0](./v0.6.0.md) | Commercial Sales Order operations and secure live synchronization |
