...
describe('ClientAccountsFacade', () => {
  ...
  it('loads list and detail states', () => {
    ...
    TestBed.configureTestingModule({ providers: [ClientAccountsFacade, { provide: CustomerRelationshipsApiService, useValue: api }] }); const facade = TestBed.inject(ClientAccountsFacade);
  ...
  it('preserves error and retries list', () => {
    ...
    TestBed.configureTestingModule({ providers: [ClientAccountsFacade, { provide: CustomerRelationshipsApiService, useValue: api }] }); const facade = TestBed.inject(ClientAccountsFacade); facade.load(); expect(facade.state().status).toBe('error'); facade.retry(); expect(api.clientAccounts).toHaveBeenCalledTimes(2);
  });
});
