...
@Component({
  ...
  `,
  styles: [`
    .filter{display:flex;align-items:center;gap:.35rem}.filter select,select{padding:.45rem}.board-help,.read-only{margin:0}.kanban{display:grid;grid-template-columns:repeat(5,minmax(13rem,1fr));gap:.75rem;overflow-x:auto;padding-bottom:.5rem}.kanban-column{min-height:14rem;padding:.65rem;background:#f8fafc;border:1px solid #dbe3ee;border-radius:.65rem}.kanban-column header{display:flex;align-items:center;justify-content:space-between;gap:.5rem}.kanban-column h3{font-size:.9rem;margin:0}.kanban-column header span{font-weight:700}.kanban-items{display:grid;gap:.5rem;margin-top:.65rem;min-height:10rem}.kanban-card{display:grid;gap:.25rem;padding:.7rem;background:#fff;border:1px solid #dbe3ee;border-radius:.5rem;box-shadow:0 2px 5px #0f172a12}.card-heading{display:flex;justify-content:space-between;gap:.5rem}.kanban-card a{font-weight:700}.kanban-card span,.kanban-card small,.drag-handle,.column-empty{color:#64748b;font-size:.8rem}.priority{font-weight:700}.drag-handle{cursor:grab;border:0;background:transparent;text-align:left;padding:.25rem 0}.move-control{display:grid;gap:.2rem;font-size:.8rem}.cdk-drag-preview{box-sizing:border-box;padding:.7rem;background:#fff;border:1px solid #0f766e;border-radius:.5rem;box-shadow:0 12px 24px #0f172a33}.cdk-drag-placeholder{opacity:.25}.cdk-drop-list-dragging .kanban-card:not(.cdk-drag-placeholder){transition:transform 150ms ease}table{width:100%;border-collapse:collapse}th,td{padding:.65rem;text-align:left;border-bottom:1px solid #ddd;vertical-align:top}button{margin-right:.4rem}@media(max-width:760px){.kanban{grid-template-columns:repeat(2,minmax(0,1fr));overflow-x:hidden}.kanban-column,.kanban-card{min-width:0}.card-heading{min-width:0;flex-wrap:wrap}.card-heading a{min-width:0;overflow-wrap:anywhere}.drag-handle{flex:0 0 auto}table{display:block;overflow-x:auto}}
  `],
