...
describe('RequestBuilderFacade', () => {
  it('loads real reference collections and creates through the sales API adapter', () => {
    ...
    TestBed.configureTestingModule({ providers: [RequestBuilderFacade, { provide: SalesCommitmentApiService, useValue: salesApi }, { provide: SalesCommitmentCustomerGateway, useValue: customerApi }, { provide: CatalogApiService, useValue: catalogApi }] });
