...
export const PLATFORM_NAVIGATION: readonly PlatformNavigationItem[] = [
  ...
  { label: 'Inventory Lots', path: '/ops/operations/inventory/lots', icon: 'category', permission: 'warehouse:read', roles: ['WAREHOUSE', 'LOGISTICS'] },
  { label: 'Stock Movements', path: '/ops/operations/inventory/movements', icon: 'swap_vert', permission: 'warehouse:read', roles: ['WAREHOUSE', 'LOGISTICS'] },
  { label: 'Reservations', path: '/ops/operations/inventory/reservations', icon: 'inventory_2', permission: 'warehouse:read', roles: ['WAREHOUSE', 'LOGISTICS'] },
