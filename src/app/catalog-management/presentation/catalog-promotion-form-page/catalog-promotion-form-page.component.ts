        ...
        <div class="promotion-layout">
          <nexa-section-panel [title]="'catalog.fields.commercialDefinition' | translate">
            <form [formGroup]="form" (ngSubmit)="save()" novalidate>
              ...
              <label>{{ 'catalog.fields.clientAccountTargets' | translate }}<textarea formControlName="clientAccountIds" rows="2" [placeholder]="'catalog.fields.idsPlaceholder' | translate"></textarea></label>
