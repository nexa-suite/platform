...
export type { WorkspaceDetails } from '../../domain/models/company-administration.models';

@Injectable({ providedIn: 'root' })
export class CompanyAdministrationApiService implements CompanyAdministrationApiPort {
