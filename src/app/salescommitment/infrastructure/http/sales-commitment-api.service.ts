...
import { CreateManualSalesOrderCommand, CreatePurchaseRequestCommand, DEFAULT_PURCHASE_REQUEST_FILTERS, PurchaseRequest, PurchaseRequestAction, PurchaseRequestEvent, PurchaseRequestFilters, PurchaseRequestLineCommand, PurchaseRequestPage, UpdatePurchaseRequestCommand, UpdatePurchaseRequestLineCommand } from '../../domain/purchase-requests/purchase-request.models';
import { DEFAULT_SALES_ORDER_FILTERS, FulfillmentCandidate, SalesOrder, SalesOrderEvent, SalesOrderFilters, SalesOrderPage } from '../../domain/sales-orders/sales-order.models';
import { ManualOrderClientCommand, ManualOrderDeliveryCommand, ManualOrderDraft, ManualOrderLineCommand, ManualOrderReview } from '../../domain/manual-orders/manual-order.models';
import { SalesCommitmentDeliveryAddressCommand } from '../../domain/customer-reference.models';
import { ApiPageDto, ApiRecord, toFulfillmentCandidate, toManualOrderDraft, toManualOrderReview, toPurchaseRequest, toPurchaseRequestEvent, toPurchaseRequestPage, toSalesOrder, toSalesOrderEvent, toSalesOrderPage } from './sales-commitment-mappers';
import { SalesCommitmentApiPort } from '../../domain/ports/sales-commitment-api.port';

@Injectable()
export class SalesCommitmentApiService implements SalesCommitmentApiPort {
...
export type { CreateManualSalesOrderCommand, CreatePurchaseRequestCommand, PurchaseRequestLineCommand, UpdatePurchaseRequestCommand, UpdatePurchaseRequestLineCommand } from '../../domain/purchase-requests/purchase-request.models';
