...
import { DEFAULT_SALES_ORDER_FILTERS, SalesOrderFilters, SalesOrderState } from '../../domain/sales-orders/sales-order.models';
...
export class SalesOrdersFacade {
  ...
  private command(request: () => ReturnType<SalesCommitmentApiPort['confirmSalesOrder']>, message: string): void {
